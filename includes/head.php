...
<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon" href="<?= $webSetting['site_favicon_url'] ?? '' ?>">
...
<link rel="stylesheet" href="<?= BASE_URL ?>assets/css/vendor/elegant.css">
<link rel="stylesheet" href="<?= BASE_URL ?>assets/css/vendor/linear-icon.css">
